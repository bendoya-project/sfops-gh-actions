...
## [27.3.0](https://github.com/flxbl-io/sfops/compare/v27.2.3...v27.3.0) (2024-04-21)


### Features

* **sfp:** update to v40.4.1 to support destructive changes ([c805010](https://github.com/flxbl-io/sfops/commit/c805010ecf8926cf232583f49d8fc12fb67dd84e))


### Bug Fixes

* **sfp:** update to v40.4.2 for flag issue ([4f54f40](https://github.com/flxbl-io/sfops/commit/4f54f40f146a6be95bb2ff6568a08be62fa6bde3))
* **validate:** ensure the first commit is used instead of the head sha provided by GitHub ([40e50b7](https://github.com/flxbl-io/sfops/commit/40e50b73cee9387aa1e7886cc32709b8ce794683))

## [27.2.3](https://github.com/flxbl-io/sfops/compare/v27.2.2...v27.2.3) (2024-04-17)


### Bug Fixes

* **sfp:** update sfp to 40.3.3 to fix issues with validation (docker update only) ([1f4afd0](https://github.com/flxbl-io/sfops/commit/1f4afd01787ce3604553b03b4641036b31ac2193))

## [27.2.2](https://github.com/flxbl-io/sfops/compare/v27.2.1...v27.2.2) (2024-04-16)


### Bug Fixes

* **sfp:** update to 40.3.1 ([323b9ae](https://github.com/flxbl-io/sfops/commit/323b9aec74bcaa69d552eb4242aee79f4547a767))
* **sfp:** update to v40.3.2 ([b8e961b](https://github.com/flxbl-io/sfops/commit/b8e961b0c542a869bd0af250a5a0070573706b50))

## [27.2.1](https://github.com/flxbl-io/sfops/compare/v27.2.0...v27.2.1) (2024-04-16)


### Bug Fixes

* **act-auth:** fix incorrect string match for prod ([7eba232](https://github.com/flxbl-io/sfops/commit/7eba2322d5d0c3b3952a04b905aca4e520aad442))
* **act-auth:** handle sandboxes that start with name prod ([1cd799f](https://github.com/flxbl-io/sfops/commit/1cd799fd4ee5533618dd46929c34662b44c12b0a))
* **act-checksandbox:** move to sfp pro ([3eaa13d](https://github.com/flxbl-io/sfops/commit/3eaa13d990c0c09e4d56be8e4ea7ce980e68fec2))

## [27.2.0](https://github.com/flxbl-io/sfops/compare/v27.1.1...v27.2.0) (2024-04-08)


### Features

* **actions:** two way sync for sandboxes ([95ed551](https://github.com/flxbl-io/sfops/commit/95ed5517442b201a751676a1f4c833e774a677a6))


### Bug Fixes

* **act-deleteSandbox:** add a true for delete command to pass ([228bec8](https://github.com/flxbl-io/sfops/commit/228bec81e68b0050ee5ffcb5327a3e7249ee0088))

## [27.1.1](https://github.com/flxbl-io/sfops/compare/v27.1.0...v27.1.1) (2024-04-05)


### Bug Fixes

* **actions:** fix incorrect derefrencing in checkSandbox action ([7d1e3f9](https://github.com/flxbl-io/sfops/commit/7d1e3f90804c97086f9f60d512d49ee0664b9e3a))

## [27.1.0](https://github.com/flxbl-io/sfops/compare/v27.0.3...v27.1.0) (2024-04-04)


### Features

* **actions:** add additonal logs after sucessfull authentication to review sandboxes ([a01841e](https://github.com/flxbl-io/sfops/commit/a01841e8b5fa9bc7bb22aa4ce86207ab2f6e9275))


### Bug Fixes

* **devcentral:** fix incorrect urls used to link to Reference Guide/Support ([a7134c4](https://github.com/flxbl-io/sfops/commit/a7134c4b21dd60e15ea7a5199dc3887c01bf105d))

## [27.0.3](https://github.com/flxbl-io/sfops/compare/v27.0.2...v27.0.3) (2024-04-02)


### Bug Fixes

* **cicd:** fix sync script parameters on release please workflow ([490de11](https://github.com/flxbl-io/sfops/commit/490de1190de1aad9ac4500abb7c489688fa6602b))

## [27.0.2](https://github.com/flxbl-io/sfops/compare/v27.0.1...v27.0.2) (2024-04-02)


### Bug Fixes

* **devcentral:** fix favicon for devcentral ([f85a2c3](https://github.com/flxbl-io/sfops/commit/f85a2c3dbd58046557248d97139b5b3c335328af))
* **sfp:** update to v40.2.0 for fix in sfp bug ([ef7688f](https://github.com/flxbl-io/sfops/commit/ef7688f51e71fa79a6c4fa2176e102394cf51653))

## [27.0.1](https://github.com/flxbl-io/sfops/compare/v27.0.0...v27.0.1) (2024-04-02)


### Bug Fixes

* **docs:** fix readme on licensing change ([9d8e5be](https://github.com/flxbl-io/sfops/commit/9d8e5be2a0cfe854b35c434af2d0614d49701202))

## [27.0.0](https://github.com/flxbl-io/sfops/compare/v26.4.3...v27.0.0) (2024-04-02)


### ⚠ BREAKING CHANGES

* **license:** Licensing is changed to MIT

### Features

* **license:** switch to MIT License ([cc9297e](https://github.com/flxbl-io/sfops/commit/cc9297efe28c012c9925e566ce85e79386691a19))
* **sfops:** allow self managed sfops ([21a09a0](https://github.com/flxbl-io/sfops/commit/21a09a0a8bebb21d1948f586a1a207f5d35842a3))
* **sfp:** update sfp to 40.1.0 ([b513b03](https://github.com/flxbl-io/sfops/commit/b513b03fc3de47b5dded6a42f8f64fbbbb83a249))


### Bug Fixes

* **cicd:** remove environment for release-please ([21a09a0](https://github.com/flxbl-io/sfops/commit/21a09a0a8bebb21d1948f586a1a207f5d35842a3))
* **readme:** fix instructions in readme ([21a09a0](https://github.com/flxbl-io/sfops/commit/21a09a0a8bebb21d1948f586a1a207f5d35842a3))
* **sync:** fix latest_tag fetch script ([21a09a0](https://github.com/flxbl-io/sfops/commit/21a09a0a8bebb21d1948f586a1a207f5d35842a3))
