...
const yargs = __nccwpck_require__(856);
...
const stripAnsi = __nccwpck_require__(479);
...
const {Yargs, processArgv} = __nccwpck_require__(926);
...
function Argv(processArgs, cwd) {
  const argv = Yargs(processArgs, cwd, __nccwpck_require__(737));
  singletonify(argv);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 34);
